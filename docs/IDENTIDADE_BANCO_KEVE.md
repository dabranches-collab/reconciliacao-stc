...
- Site institucional: <https://keve.ao/>
- Perfil, missão, visão, valores e cultura: <https://www.keve.ao/o-keve/our-profile>
- Reposicionamento da marca: <https://www.keve.ao/noticias/60-21-anos-a-avancar-banco-keve-celebra-aniversario>
...
- Pilares culturais: Cliente no ADN, Somos Um, Atitude Ágil, Olhos no Futuro e Liderança com Propósito.

## Aplicação no produto

- A interface deve parecer uma ferramenta operacional interna do Keve, não um produto genérico com o nome do banco aplicado por cima.
- Rigor, integridade e rastreabilidade prevalecem sobre automatização aparente.
...
A identidade visual não autoriza publicação de dados bancários. Qualquer versão pública deve usar dados fictícios ou controlo de acesso efectivo.
