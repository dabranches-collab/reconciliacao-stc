...
- Identidade PWA actualizada com símbolo laranja de transferências opostas e conciliação confirmada; SVG, PNG 192/512 e Apple Touch Icon gerados e validados localmente. Publicação desta revisão aguarda autorização explícita para republicar a aplicação completa.
